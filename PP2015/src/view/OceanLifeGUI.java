...
public class OceanLifeGUI {
	...
	public OceanLifeGUI(Ocean ocean, OceanLifeController oceanLifeController) {
		oi = ocean;
		frame = new JFrame();
		
		frame.setLayout(null);
		frame.setSize(ocean.getWidth(),ocean.getDepth());
	...
	public class DrawGUI extends JPanel {
		...
		public void paintComponent(Graphics g) {
			...
			try {
				...
				g2.drawImage(ImageIO.read(OceanLifeGUI.class.getResource("/res/Ocean.png")), 0, 0, null);
